...
#define SAMPLE_DEVICE_NAME          "Lop1-Nhom4"
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
           if (!param->write.is_prep){
                ...
                task_ssd1306_display_text(data_to_display);
            }else{
